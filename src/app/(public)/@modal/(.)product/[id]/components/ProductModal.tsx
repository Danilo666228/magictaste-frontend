...
import { IngredientList } from '@/app/(public)/product/(components)/IngredientList'
					...
					<div className='flex flex-col justify-between gap-3 p-2 sm:p-4'>
						...
						<div className='mt-auto flex flex-col items-stretch gap-3 sm:flex-row sm:items-center'>
							...
							<Button
								...
								size='icon'>
								<Heart
									className={cn('group-hover:text-red-500', isActiveFavorite(profile?.data, product) && 'text-red-500')}
								/>
							</Button>
						</div>
