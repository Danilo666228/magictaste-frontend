	...
	return (
		<>
			<motion.div
				...
				<div
					className="absolute inset-0 bg-gradient-to-br from-primary/[0.02] to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />

				<div className="relative space-y-4">
					<div className="flex items-start justify-between">
						<div className="flex gap-4">
							<Avatar
								className="h-12 w-12 ring-2 ring-primary/10 ring-offset-2 transition-all duration-300 group-hover:ring-primary/30">
					...
					<div className="relative rounded-xl bg-primary/[0.02] p-4">
						<Typography
							className="break-words text-base leading-relaxed text-neutral-700">{comment.comment}</Typography>
					</div>
			...
			<Modal title={'Ответить на комментарий'} open={isOpenReplyForm} onOpenChange={setIsOpenReplyForm}>
				<ProductCommentForm product={comment.product} commentId={comment.id} />
			</Modal>
		</>
	)
}
