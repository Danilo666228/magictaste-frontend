			...
			<CardContent className='flex flex-col items-center gap-6 p-6'>
				<div className='group relative'>
					<Avatar
						...
						<Modal title='Изменение аватара' open={isOpen} onOpenChange={setIsOpen}>
							<ImageUpload
								onSubmit={async file => {
						...
						<div className='absolute inset-0 flex items-center justify-center rounded-full bg-black/30 opacity-0 backdrop-blur-sm transition-opacity group-hover:opacity-100'>
