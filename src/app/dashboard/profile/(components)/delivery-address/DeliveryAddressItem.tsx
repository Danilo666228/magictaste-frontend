...
export const DeliveryAddressItem = ({ deliveryAddress }: DeliveryAddressItemProps) => {
	...
	return (
		<Accordion className='overflow-hidden rounded-lg border' type='multiple'>
			<AccordionItem className='border-0' value={deliveryAddress.id}>
					...
					<div className='flex w-full items-center justify-between gap-x-4'>
						...
						<div className='mr-auto space-y-1 text-left'>
							<div className='flex items-center gap-2'>
								<Typography className='font-semibold tracking-wide' tag='h3'>
				...
				<AccordionContent className='bg-muted/5'>
					<div className='space-y-4 p-5'>
						...
						<div className='flex justify-end gap-2'>
							<Button className='gap-1' size='sm' variant='destructive' onClick={handleDelete}>
								<Trash2 size={14} />
								Удалить
							</Button>
						</div>
