	...
	return (
		<main
			...
			className={cn(
				...
				'md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:mx-3 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow',
				className
			)}
			{...props}
		/>
