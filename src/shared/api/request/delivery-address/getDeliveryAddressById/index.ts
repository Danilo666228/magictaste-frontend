...
export const getDeliveryAddressById = ({ params, config }: GetDeliveryAddressByIdRequestConfig) =>
	api.get<DeliveryAddress>(`/delivery-address/${params.deliveryAddressId}`, config)
